...
struct AETHERION_ENGINE_API EntityMap final {
...
struct AETHERION_ENGINE_API World {
...
struct AETHERION_ENGINE_API ChildrenRange {
	struct AETHERION_ENGINE_API Iterator {
		void operator ++();
