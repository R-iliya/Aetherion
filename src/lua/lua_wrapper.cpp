...
namespace Aetherion::LuaWrapper {
...
int traceback(lua_State *L) {
	...
	lua_getfield(L, LUA_GLOBALSINDEX, "AetherionDebugCallback");
...
void pushEntity(lua_State* L, EntityPtr value, World* world) {
	lua_getglobal(L, "Aetherion");						// [Aetherion]
	lua_getfield(L, -1, "Entity");					// [Aetherion, Aetherion.Entity]
	lua_remove(L, -2);								// [Aetherion.Entity]
	lua_getfield(L, -1, "new");						// [Aetherion.Entity, Entity.new]
	lua_pushvalue(L, -2);							// [Aetherion.Entity, Entity.new, Aetherion.Entity]
	lua_remove(L, -3);								// [Entity.new, Aetherion.Entity]
	lua_pushlightuserdata(L, world);				// [Entity.new, Aetherion.Entity, world]
	lua_pushnumber(L, value.index);					// [Entity.new, Aetherion.Entity, world, entity_index]
...
void pushObject(lua_State* L, void* obj, StringView type_name) {
	...
	lua_newtable(L); // [AetherionAPI, class, obj]
	lua_pushlightuserdata(L, obj); // [AetherionAPI, class, obj, obj_ptr]
	lua_setfield(L, -2, "_value"); // [AetherionAPI, class, obj]
	lua_pushvalue(L, -2); // [AetherionAPI, class, obj, class]
	lua_setmetatable(L, -2); // [AetherionAPI, class, obj]
	lua_remove(L, -2); // [AetherionAPI, obj]
	lua_remove(L, -2); // [obj]
}
