...
AETHERION_EDITOR_API void addCircle(WorldView& view, const DVec3& center, float radius, const Vec3& up, Color color);
AETHERION_EDITOR_API void addSphere(WorldView& view, const DVec3& center, float radius, Color color);
AETHERION_EDITOR_API void addCube(WorldView& view, const DVec3& center, const Vec3& x, const Vec3& y, const Vec3& z, Color color);
AETHERION_EDITOR_API void addCube(WorldView& view, const DVec3& min, const DVec3& max, Color color);
AETHERION_EDITOR_API void addLine(WorldView& view, const DVec3& a, const DVec3& b, Color color);
AETHERION_EDITOR_API void addCylinder(WorldView& view, const DVec3& pos, const Vec3& up, float radius, float height, Color color);
AETHERION_EDITOR_API void addCone(WorldView& view, const DVec3& vertex, const Vec3& dir, const Vec3& axis0, const Vec3& axis1, Color color);
AETHERION_EDITOR_API void addFrustum(WorldView& view, const struct ShiftedFrustum& frustum, Color color);
AETHERION_EDITOR_API void addCapsule(WorldView& view, const DVec3& position, float height, float radius, Color color);

struct AETHERION_EDITOR_API WorldEditor
{
