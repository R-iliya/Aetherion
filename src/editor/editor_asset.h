...
struct AETHERION_EDITOR_API EditorAssetPlugin : AssetBrowser::IPlugin, AssetCompiler::IPlugin {
...
struct AETHERION_EDITOR_API AssetEditorWindow : StudioApp::GUIPlugin {
