...
CompositeTexture::Node* createNode(CompositeTexture::NodeType type, CompositeTexture& resource, IAllocator& allocator) {
	...
	switch (type) {
		case CompositeTexture::NodeType::OUTPUT: node = AETHERION_NEW(allocator, OutputNode)(allocator); break;
		case CompositeTexture::NodeType::INPUT: node = AETHERION_NEW(allocator, InputNode)(allocator); break;
		case CompositeTexture::NodeType::FLIP: node = AETHERION_NEW(allocator, FlipNode)(allocator); break;
		case CompositeTexture::NodeType::INVERT: node = AETHERION_NEW(allocator, InvertNode)(allocator); break;
		case CompositeTexture::NodeType::COLOR: node = AETHERION_NEW(allocator, ColorNode)(allocator); break;
		case CompositeTexture::NodeType::SPLIT: node = AETHERION_NEW(allocator, SplitNode)(allocator); break;
		case CompositeTexture::NodeType::MERGE: node = AETHERION_NEW(allocator, MergeNode)(allocator); break;
		case CompositeTexture::NodeType::GAMMA: node = AETHERION_NEW(allocator, GammaNode)(allocator); break;
		case CompositeTexture::NodeType::CROP: node = AETHERION_NEW(allocator, CropNode)(allocator); break;
		case CompositeTexture::NodeType::CONTRAST: node = AETHERION_NEW(allocator, ContrastNode)(allocator); break;
		case CompositeTexture::NodeType::BRIGHTNESS: node = AETHERION_NEW(allocator, BrightnessNode)(allocator); break;
		case CompositeTexture::NodeType::RESIZE: node = AETHERION_NEW(allocator, ResizeNode)(allocator); break;
		case CompositeTexture::NodeType::SPLAT: node = AETHERION_NEW(allocator, SplatNode)(allocator); break;
		case CompositeTexture::NodeType::CELLULAR_NOISE: node = AETHERION_NEW(allocator, CellularNoiseNode)(allocator); break;
		case CompositeTexture::NodeType::GRADIENT_NOISE: node = AETHERION_NEW(allocator, GradientNoiseNode)(allocator); break;
		case CompositeTexture::NodeType::WAVE_NOISE: node = AETHERION_NEW(allocator, WaveNoiseNode)(allocator); break;
		case CompositeTexture::NodeType::BLUR: node = AETHERION_NEW(allocator, BlurNode)(allocator); break;
		case CompositeTexture::NodeType::NORMALMAP: node = AETHERION_NEW(allocator, NormalmapNode)(allocator); break;
		case CompositeTexture::NodeType::TWIRL: node = AETHERION_NEW(allocator, TwirlNode)(allocator); break;
		case CompositeTexture::NodeType::WARP: node = AETHERION_NEW(allocator, WarpNode)(allocator); break;
		case CompositeTexture::NodeType::CHECKERBOARD: node = AETHERION_NEW(allocator, CheckerboardNode)(allocator); break;
		case CompositeTexture::NodeType::TRIANGLE: node = AETHERION_NEW(allocator, TriangleNode)(allocator); break;
		case CompositeTexture::NodeType::SQUARE: node = AETHERION_NEW(allocator, SquareNode)(allocator); break;
		case CompositeTexture::NodeType::CIRCLE: node = AETHERION_NEW(allocator, CircleNode)(allocator); break;
		case CompositeTexture::NodeType::SET_ALPHA: node = AETHERION_NEW(allocator, SetAlphaNode)(allocator); break;
		case CompositeTexture::NodeType::CURVE: node = AETHERION_NEW(allocator, CurveNode)(allocator); break;
		case CompositeTexture::NodeType::GRAYSCALE: node = AETHERION_NEW(allocator, GrayscaleNode)(allocator); break;
		case CompositeTexture::NodeType::CONSTANT: node = AETHERION_NEW(allocator, ConstantNode)(allocator); break;
		case CompositeTexture::NodeType::MULTIPLY: node = AETHERION_NEW(allocator, MultiplyNode)(allocator); break;
		case CompositeTexture::NodeType::MIX: node = AETHERION_NEW(allocator, MixNode)(allocator); break;
		case CompositeTexture::NodeType::GRADIENT: node = AETHERION_NEW(allocator, GradientNode)(allocator); break;
		case CompositeTexture::NodeType::VALUE_NOISE: node = AETHERION_NEW(allocator, RandomPixelsNode)(allocator); break;
		case CompositeTexture::NodeType::SHARPEN: node = AETHERION_NEW(allocator, SharpenNode)(allocator); break;
		case CompositeTexture::NodeType::GRADIENT_MAP: node = AETHERION_NEW(allocator, GradientMapNode)(allocator); break;
		case CompositeTexture::NodeType::CIRCULAR_SPLATTER: node = AETHERION_NEW(allocator, CircularSplatterNode)(allocator); break;
		case CompositeTexture::NodeType::PIXEL_PROCESSOR: node = AETHERION_NEW(allocator, PixelProcessorNode)(allocator); break;
		case CompositeTexture::NodeType::SPLATTER: node = AETHERION_NEW(allocator, SplatterNode)(allocator); break;
		case CompositeTexture::NodeType::TRANSLATE: node = AETHERION_NEW(allocator, TranslateNode)(allocator); break;
		case CompositeTexture::NodeType::STATIC_SWITCH: node = AETHERION_NEW(allocator, StaticSwitchNode)(allocator); break;
		case CompositeTexture::NodeType::STEP: node = AETHERION_NEW(allocator, StepNode)(allocator); break;
		case CompositeTexture::NodeType::PIXEL_COLOR: node = AETHERION_NEW(allocator, PixelNode<CompositeTexture::NodeType::PIXEL_COLOR>)(allocator); break;
		case CompositeTexture::NodeType::PIXEL_X: node = AETHERION_NEW(allocator, PixelNode<CompositeTexture::NodeType::PIXEL_X>)(allocator); break;
		case CompositeTexture::NodeType::PIXEL_Y: node = AETHERION_NEW(allocator, PixelNode<CompositeTexture::NodeType::PIXEL_Y>)(allocator); break;
		case CompositeTexture::NodeType::PIXEL_CTX_W: node = AETHERION_NEW(allocator, PixelNode<CompositeTexture::NodeType::PIXEL_CTX_W>)(allocator); break;
		case CompositeTexture::NodeType::PIXEL_CTX_H: node = AETHERION_NEW(allocator, PixelNode<CompositeTexture::NodeType::PIXEL_CTX_H>)(allocator); break;
		case CompositeTexture::NodeType::DIVIDE: node = AETHERION_NEW(allocator, MathNode<CompositeTexture::NodeType::DIVIDE>)(allocator); break;
		case CompositeTexture::NodeType::MAX: node = AETHERION_NEW(allocator, MathNode<CompositeTexture::NodeType::MAX>)(allocator); break;
		case CompositeTexture::NodeType::MIN: node = AETHERION_NEW(allocator, MathNode<CompositeTexture::NodeType::MIN>)(allocator); break;
	}
...
void CompositeTexture::clear() {
	...
	for (Node* n : m_nodes) {
		...
		AETHERION_DELETE(m_allocator, n);
	}
	m_nodes.clear();
...
void CompositeTexture::removeArrayLayer(u32 idx) {
	...
	AETHERION_DELETE(m_allocator, input.node);
