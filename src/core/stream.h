...
struct AETHERION_CORE_API IOutputStream {
...
struct AETHERION_CORE_API IInputStream {
...
struct AETHERION_CORE_API OutputPagedStream final : IOutputStream {
...
struct AETHERION_CORE_API InputPagedStream final : IInputStream {
...
struct AETHERION_CORE_API OutputMemoryStream final : IOutputStream {
...
struct AETHERION_CORE_API InputMemoryStream final : IInputStream {
