...
struct AETHERION_CORE_API RuntimeHash {
...
struct AETHERION_CORE_API RuntimeHash32 {
...
// 64bits 
struct AETHERION_CORE_API StableHash {
...
struct AETHERION_CORE_API StableHash32 {
...
struct AETHERION_CORE_API RollingStableHasher {
	void begin();
...
// begin/end pair cannot cross thread boundaries
struct AETHERION_CORE_API RollingHasher {
	void begin();
	void update(const void* data, u32 len);
	RuntimeHash32 end();
};
